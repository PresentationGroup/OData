...
namespace ODataAlternateKeySample.Models
{
    public class EdmModelBuilder
    {
        public static IEdmModel GetEdmModel()
        {
            ...
            builder.EntitySet<Models.DB.Test>("Tests");
            builder.EntitySet<Models.DB.Test>("Students");
            ...
            builder.EntityType<Models.DB.Test>().Collection
                .Function("MostExpensive")
                .Returns<Models.DB.Test>();


            builder.Namespace = "ProductService";
            builder.EntityType<Models.DB.Test>()
                .Action("Rate")
